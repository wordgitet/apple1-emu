...
tests: $(TEST_TARGET) $(ACI_TEST_TARGET) $(DUALRAM_TEST_TARGET)
	./$(TEST_TARGET)
	./$(ACI_TEST_TARGET)
	./$(DUALRAM_TEST_TARGET)
...
clean:
	rm -f $(CORE_OBJS) term_sdl3.o main.o $(GUI_TARGET) $(TEST_OBJS) $(TEST_TARGET) $(ACI_TEST_OBJS) $(ACI_TEST_TARGET) $(DUALRAM_TEST_OBJS) $(DUALRAM_TEST_TARGET) 6502_functional_test.bin
